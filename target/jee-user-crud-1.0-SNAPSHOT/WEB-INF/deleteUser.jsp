        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="p-5">
                <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Czy na pewno chcesz usunąć użytkownika?</h1>
                </div>
                ...
                <a href="/user/confirmDelete"><button type="button" class="btn btn-primary btn-user btn-block">Potwierdź</button></a>
                <br>
